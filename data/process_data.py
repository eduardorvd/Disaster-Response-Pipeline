...
def load_data(messages_filepath, categories_filepath):
    ...
    INPUT
    messages_filepath -- csv file with disaster messages
    categories_filepath -- csv file with categories messages
    OUTPUT
    df - pandas DataFrame
    """
...
def clean_data(df):
    """
    Function that cleans the message and categories data
